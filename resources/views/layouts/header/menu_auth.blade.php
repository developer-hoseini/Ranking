        ...
        <div class="menu-nav-right mx-auto">
            <div title="{{__('words.menu')}}" onclick="menu_item();" class="text-decoration-none menu-toggler-btn mx-1 d-inline-block">
                {{-- @if($chats_count>0 || $unconfirmed_quick_submitted>0 || $team_invites_count>0 || $support_new_ticket>0 || $tournament_invite>0)
                    <img src="{{url('img/menu/notify/menu.png')}}" height="32px" class="menu-white-icons">
                    <img src="{{url('img/menu/notify/menu-dark.png')}}" height="32px" class="menu-dark-icons">
                @else
                    <img src="{{url('img/menu/menu.png')}}" height="32px" class="menu-white-icons">
                    <img src="{{url('img/menu/menu-dark.png')}}" height="32px" class="menu-dark-icons">
                @endif --}}
            </div>
            <a href="{{route('quick_submit')}}" title="{{__('words.quick_submit_result')}}" class="text-decoration-none d-inline-block mx-1">
                <img src="{{url('img/menu/submit_result.png')}}" height="28px" class="menu-white-icons" style="position: relative;bottom: 2px;">
                <img src="{{url('img/menu/submit_result-dark.png')}}" height="28px" class="menu-dark-icons">
            </a>
        </div>
        <div class="menu-nav-center mx-auto">
            <a href="{{ route('home') }}" title="{{__('words.Ranking')}}"><img src="{{url('img/white-ranking.png')}}" height="40px" class="responsive-logo"></a>
        </div>
        <div class="menu-nav-left mx-auto">
            <div title="{{session('fullname')}}" onclick="profile_item();" class="text-decoration-none menu-toggler-btn d-inline-block mx-1">
            ...
            <div title="{{ __('words.coin_count') }}" class="text-decoration-none menu-toggler-btn d-inline-block mx-1" onclick="coin_item();">
                <img src="{{url('img/menu/coin.png?c=1')}}" height="31px">
            </div>
        </div>
        <div class="w-100 text-center menu-nav-btns">
            <a href="{{route('tournament.index')}}" title="{{ __('words.matches') }}" class="menu-nav-circle-btn" id="menu-nav-c-btn-1">
                <img src="{{url('img/menu/tournament-red.png')}}" width="20px">
            </a>
            <a href="{{route('ranks')}}" title="{{ __('words.ranks_table') }}" class="menu-nav-circle-btn" id="menu-nav-c-btn-2">
                <img src="{{url('img/menu/ranks-red.png')}}" width="20px">
            </a>
            <a href="{{ route('home') }}" title="{{__('words.home')}}" class="menu-nav-home-btn">
                <img src="{{url('img/menu/home.png')}}" height="25px">
            </a>
            <a href="{{route('events')}}" title="{{ __('words.Events') }}" class="menu-nav-circle-btn" id="menu-nav-c-btn-4">
                {{-- @if($events_count>0)
                    <img src="{{url('img/menu/notify/events-red.png')}}" width="25px">
                @else
                    <img src="{{url('img/menu/events-red.png')}}" width="22px">
                @endif --}}
            </a>
            <div class="menu-nav-circle-btn font-weight-bold" style="font-family: IranSans_Black;" onclick="language_btn();" title="{{__('words.Language')}}" id="menu-nav-c-btn-5">{{$locale}}</div>
        </div>
    </div>
</nav>
...
<div class="menu-list" id="menu-item">
    <div class="menu-list-box bg-white" id="profile-menu-box">
        <a href="{{route('quick_submitted_list')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                {{-- @if($unconfirmed_quick_submitted>0)
                    <img src="{{url('img/menu/notify/result_submit.png')}}" width="45px" class="mt-1">
                @else
                    <img src="{{url('img/menu/result_submit.png')}}" width="45px" class="mt-1">
                @endif --}}
        ...
        <a href="{{route('team_ranks')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                <img src="{{url('img/menu/team_ranks.png')}}" width="45px" class="mt-1">
                <div class="text-dark mt-1">{{ __('words.Team_Ranks') }}</div>
            </div>
        </a>
        <a href="{{route('games')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                <img src="{{url('img/menu/game.png')}}" width="45px" class="mt-1">
        ...
        {{-- <a href="{{route('my_tournament.index')}}@if($tournament_invite>0)#invited @endif" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                @if($tournament_invite>0)
                    <img src="{{url('img/menu/notify/my_tournament.png')}}" width="45px" class="mt-1">
                @else
                    <img src="{{url('img/menu/my_tournament.png')}}" width="45px" class="mt-1">
                @endif
        ...
        <a href="@if($team_invites_count>0){{route('joined_teams')}} @else {{route('my_teams')}} @endif" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                @if($team_invites_count>0)
                    <img src="{{url('img/menu/notify/team.png')}}" width="45px" class="mt-1">
                @else
                    <img src="{{url('img/menu/team.png')}}" width="45px" class="mt-1">
                @endif
        ...
        <a href="{{route('chats')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                @if($chats_count>0)
                    <img src="{{url('img/menu/notify/chat.png')}}" width="45px" class="mt-1">
                @else
                    <img src="{{url('img/menu/chat.png')}}" width="45px" class="mt-1">
                @endif
        ...
        <a href="{{route('tickets.index')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                @if($support_new_ticket >0)
                    <img src="{{url('img/menu/notify/support.png')}}" width="45px" class="mt-1">
                @else
                    <img src="{{url('img/menu/support.png')}}" width="45px" class="mt-1">
                @endif
        ...
        <a href="{{route('rules')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                <img src="{{url('img/menu/rules.png')}}" width="45px" class="mt-1">
                <div class="text-dark mt-1">{{ __('words.Rules') }}</div>
            </div>
        </a>
        <a href="{{route('tutorial')}}" style="text-decoration: none;">
            <div class="menu-list-item text-center">
                <img src="{{url('img/menu/tutorial.png')}}" width="45px" class="mt-1">
...
<div class="menu-list" id="coin-item">
    <div class="menu-list-box bg-white menu-left-list-box">
        <div class="text-center">
            <a href="{{route('charge')}}">
                <img src="{{url('img/menu/coin.png?c=1')}}" width="130px" class="mt-2 rounded-circle">
            </a>
         ...
         <div class="mt-3 py-2" style="display: flex;width: 100%; border-top: solid 1px #bbb;">
            <a href="https://ranking.metagamescoin.io/forms/?page_id=130" style="text-decoration: none;margin: 0 auto;">
                <div class="menu-list-item text-center">
                    <img src="{{url('img/menu/coin_buy.png?c=2')}}" width="45px" class="mt-1">
